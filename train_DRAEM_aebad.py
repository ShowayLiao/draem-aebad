import torch
from data_loader import MVTecDRAEMTrainDataset,AeBADDRAEMTRAINDataset
...
def train_on_device(obj_names, args):
    ...
    for obj_name in obj_names:
        ...
        dataset = AeBADDRAEMTRAINDataset(args.data_path + obj_name + "/train/good/", args.anomaly_source_path, resize_shape=[256, 256])
